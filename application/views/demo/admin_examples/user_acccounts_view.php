				...
				<?php echo form_open(current_url());	?>
					<fieldset>
						...
						<input type="text" id="search" name="search_query" value="<?php echo set_value('search_users',$search_query);?>" class="tooltip_trigger"
							title="Search users by email, first name and last name."
						/>
				...
				<?php echo form_open(current_url());	?>
					<table>
						...
						<tbody>
							...
							if($user[$this->flexi_auth->db_column('user_acc', 'email')] != "aumi.aik7@gmail.com") {
							?>
							...
							<tr>
								...
								<td class="align_ctr">
									<a href="<?php echo $base_url.'auth_admin/update_user_account/'.$user[$this->flexi_auth->db_column('user_acc', 'id')];?>">Manage</a>
								</td>
								<td class="align_ctr">
